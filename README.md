...
2. [2022 04 26 Week Challenges(Tuesday)](#2022-04-26-Tuesday)
...
3. [2022 04 27 Week Challenges(Wednesday)](#2022-04-27-Wednesday)
...
4. [2022 04 28 Week Challenges(Thursday)](#2022-04-28-Thursday)
...
5. [2022 04 29 (Friday)](#2022-04-29-Friday)
...
2. [2022 05 03 Week Challenges(Tuesday)](#2022-04-26-Tuesday)
...
3. [2022 05 04 Week Challenges(Wednesday)](#2022-04-27-Wednesday)
...
4. [2022 05 05 Week Challenges(Thursday)](#2022-04-28-Thursday)
...
2. [2022 05 10 Week Challenges(Tuesday)](#2022-04-10-Tuesday)
...
3. [2022 05 11 Week Challenges(Wednesday)](#2022-05-11-Wednesday)
...
4. [2022 05 12 Week Challenges(Thursday)](#2022-05-12-Thursday)
...
5. [2022 05 13 (Friday)](#2022-05-13-Friday)
...
2. [2022 05 17 Week Challenges(Tuesday)](#2022-04-17-Tuesday)
...
3. [2022 05 18 Week Challenges(Wednesday)](#2022-05-18-Wednesday)
...
4. [2022 05 19 Week Challenges(Thursday)](#2022-05-19-Thursday)
...
5. [2022 05 20 (Friday)](#2022-05-20-Friday)


# WEEK 7


1. [2022 05 23 Week Challenges(Monday)](#2022-05-23-Monday)
	1. [Input/Output playground, using Typescript](#1-Get-Started-With-TypeScript-guided-exercise)
	2. [Readme - OOP exercise](#2-Declare-Variable-Types-In-TypeScript-guided-exercise)
2. [2022 05 24 Week Challenges(Tuesday)](#2022-04-24-Tuesday)
	1. [Menu exercise, using Typescript](#1-A-Rule-Of-Divisibility-By-13-exercise-using-Typescript)
	2. [Movies exercise, using Typescript](#2-Playing-With-Digites-exercise-using-Typescript)
3. [2022 05 25 Week Challenges(Wednesday)](#2022-05-25-Wednesday)
	1. [Interfaces guided exercise, using Typescript](#1-Duplicate-Encoder-exercise-using-Typescript)
	2. [Build Tower exercise, using Typescript](#2-Find-The-Odd-Int-exercise-using-Typescript)
	3. [Meeting exercise, using Typescript](#2-Find-The-Odd-Int-exercise-using-Typescript)
4. [2022 05 26 Week Challenges(Thursday)](#2022-05-26-Thursday)
	1. [Watch Object Oriented Programming - The Four Pillars of OOP](#1-Tile-exercise-using-Typescript)
	2. [Watch Abstract Classes vs Interfaces](#2-Time-exercise-using-Typescript)
	3. [Read Abstract Classes](#3-Rational-exercise-using-Typescript)
	4. [✨ 5th Core Challenge, update your resume here](#3-Rational-exercise-using-Typescript)
5. [2022 05 27 (Friday)](#2022-05-27-Friday)


# WEEK 8


1. [2022 05 30 Week Challenges(Monday)](#2022-05-30-Monday)
	1. [Get Started With TypeScript guided exercise](#1-Get-Started-With-TypeScript-guided-exercise)
	2. [Declare Variable Types In TypeScript guided exercise](#2-Declare-Variable-Types-In-TypeScript-guided-exercise)
	3. [Watch Object-Oriented Programming - Resume video](#3-Watch-Object-Oriented-Programming-Resume-video)
2. [2022 05 31 Week Challenges(Tuesday)](#2022-05-31-Tuesday)
	1. [Develop typed functions by using TypeScript guided exercise, using Typescript](#1-A-Rule-Of-Divisibility-By-13-exercise-using-Typescript)
	2. [Declare and instantiate classes in TypeScript guided exercise, using Typescript](#2-Playing-With-Digites-exercise-using-Typescript)
	3. [Watch Abstract Classes vs Interfaces video](#3-Valid-Braces-exercise-using-Typescript)
3. [2022 06 01 Week Challenges(Wednesday)](#2022-06-01-Wednesday)
	1. [Define generics in TypeScript guided exercise, using Typescript](#1-Duplicate-Encoder-exercise-using-Typescript)
	2. [Make the Deadfish Swim exercise, using Typescript](#2-Find-The-Odd-Int-exercise-using-Typescript)
4. [2022 06 02 Week Challenges(Thursday)](#2022-06-02-Thursday)
	1. [Generics exercise, using Typescript](#1-Tile-exercise-using-Typescript)
	2. [TicTacToe exercise, using Typescript](#2-Time-exercise-using-Typescript)
	3. [✨ 6th Core Challenge, complete your Interview Prep Core Challenge](#3-Rational-exercise-using-Typescript)
5. [2022 06 03 (Friday)](#2022-06-03-Friday)


# WEEK 9


1. [2022 06 06 Week Challenges(Monday)](#2022-06-06-Monday)
	1. [Check the All You Need To Know About TypeScript video](#1-Check-the-All-You-Need-To-Know-About-TypeScript-video)
	2. [Read this Answer, for the following question: "What is TypeScript and why would I use it in place of JavaScript?"](#2-Declare-Variable-Types-In-TypeScript-guided-exercise)
	3. [Check the 5 reasons to use TypeScript video](#3-Watch-Object-Oriented-Programming-Resume-video)
2. [2022 06 07 Week Challenges(Tuesday)](#2022-06-07-Tuesday)
	1. [Review OOP concepts again with the Fundamental Concepts of Object Oriented Programming video](#1-A-Rule-Of-Divisibility-By-13-exercise-using-Typescript)
	2. [Check this Object Oriented Programming - The Four Pillars of OOP video, this video use Java, but the idea is the same](#2-Playing-With-Digites-exercise-using-Typescript)
3. [2022 06 08 Week Challenges(Wednesday)](#2022-06-08-Wednesday)
	1. [Check Four OOP principles video](#1-Duplicate-Encoder-exercise-using-Typescript)
	2. [Check S.O.L.I.D video](#2-Find-The-Odd-Int-exercise-using-Typescript)
	3. [Check another S.O.L.I.D video](#2-Find-The-Odd-Int-exercise-using-Typescript)
4. [2022 06 09 Week Challenges(Thursday)](#2022-06-09-Thursday)
	1. [Read about OOP in Post 0](#1-Tile-exercise-using-Typescript)
	2. [Read about OOP in Post 1](#2-Time-exercise-using-Typescript)
5. [2022 06 10 (Friday)](#2022-06-10-Friday)
